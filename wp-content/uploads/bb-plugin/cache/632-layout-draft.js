...
var wpAjaxUrl='http://estudioagil.com/hencorp/wp-admin/admin-ajax.php';var flBuilderUrl='http://estudioagil.com/hencorp/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://estudioagil.com/hencorp/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://estudioagil.com/hencorp/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
else if(this.settings.layout=='gallery'){this.gallery.resize();elements.css('visibility','visible');}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5ada5cf9cca3a',layout:'grid',pagination:'numbers',postSpacing:'20',postWidth:'200',matchHeight:1});});$(window).on('load',function(){$('.fl-node-5ada5cf9cca3a .fl-post-grid').masonry('reloadItems');});})(jQuery);(function($){$(function(){$('.fl-map').on('click',function(){$(this).find('iframe').css('pointer-events','auto');});});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();